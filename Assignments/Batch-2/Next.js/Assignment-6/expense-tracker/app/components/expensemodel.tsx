...
const ExpanseModel = ({ isOpen, onClose, onAddExpense, onUpdateExpense, expense }: ExpenseModalProps) => {
    const [amount, setAmount] = useState<number>(0);
    const [category, setCategory] = useState<string>('');
    const [note, setNote] = useState<string>('');
    const [date, setDate] = useState<string>('');

    const categories = ["Groceries", "Rent", "Utilities", "Grossery", 'Entertainment', 'Online Purchases', 'Other']
